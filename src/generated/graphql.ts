...
> = {
  createList?: Resolver<
    ...
    ParentType,
    ContextType,
    RequireFields<MutationCreateListArgs, "title">
  >;
  createTask?: Resolver<
    ResolversTypes["Task"],
    ParentType,
    ContextType,
    RequireFields<MutationCreateTaskArgs, "title" | "status" | "listId">
  >;
  updateTask?: Resolver<
    ResolversTypes["Boolean"],
    ParentType,
    ContextType,
    RequireFields<MutationUpdateTaskArgs, "id" | "title" | "status">
  >;
  updateTaskOrder?: Resolver<
    ResolversTypes["Boolean"],
    ParentType,
    ContextType,
    RequireFields<MutationUpdateTaskOrderArgs, "listId" | "taskId" | "order">
  >;
};
